    ...
    public class KwikKwekSnackContext : DbContext
    {
        ...
        private void FillExtraSeedData(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Extra>().HasData( 
                new Extra { Id = 1, Name = "IJsklontjes", Price = 0.10, Active = true},
                new Extra { Id = 2, Name = "Rietje", Price = 0.15, Active = true },
                new Extra { Id = 3, Name = "Slagroom", Price = 0.20, Active = true },
                new Extra { Id = 4, Name = "Sla", Price = 0.25, Active = true },
                new Extra { Id = 5, Name = "Mayonnaise", Price = 0.25, Active = true }
            );
        }
        ...
        private void FillDrinkSizeSeedData(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DrinkSize>().HasData(
                ...
                new DrinkSize { Id = 4, ShortName = "XL", FullName = "Extra Large", PriceMultiplier = 1.75 }
            );
        }
        private void FillSnackSeedData(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Snack>().HasData(
                new Snack { Id = 1, Name = "Beef Burger", Description = "Rundvlees hamburger", StandardPrice = 2.50, ImageURL = "https://imgs.search.brave.com/DyyLM6KzO1StGQnV_w3sPjLgSZyelGWt7GQcDkUDXqA/rs:fit:612:539:1/g:ce/aHR0cHM6Ly9tZWRp/YS5pc3RvY2twaG90/by5jb20vcGhvdG9z/L2ZyZXNoLWJ1cmdl/ci1pc29sYXRlZC1w/aWN0dXJlLWlkMTEy/NTE0OTE4Mz9rPTYm/bT0xMTI1MTQ5MTgz/JnM9NjEyeDYxMiZ3/PTAmaD1LeFNmVlVr/M0tQM0JnSFZZYm95/TDlhUkxIcC1mUlly/ZlBjRmVhMHc2OE93/PQ", Active = true },
                new Snack { Id = 2, Name = "Friet", Description = "Gefrituurde aardappelen", StandardPrice = 1.50, Active = true },
                new Snack { Id = 3, Name = "Frikandel", Description = "Gefrituurde vleesrol", StandardPrice = 1.00, ImageURL = "https://imgs.search.brave.com/zjRHgiREOLZtvFh-TiPRqiUPLR_1JGBTiErIRUY89UI/rs:fit:800:568:1/g:ce/aHR0cHM6Ly90aHVt/YnMuZHJlYW1zdGlt/ZS5jb20vYi9mcmlr/YW5kZWwtdW0tcGV0/aXNjby1ob2xhbmQl/QzMlQUFzLXRyYWRp/Y2lvbmFsLW1laW8t/Y2FjaG9ycm8tcXVl/bnRlLXRyaXR1cmFk/by1kYS1jYXJuZS1w/ciVDMyVCM3hpbW8t/YWNpbWEtZG8tMTUy/MTc2MzMwLmpwZw", Active = true },
                new Snack { Id = 4, Name = "Pizza Salami", Description = "Pizza met plakjes salami", StandardPrice = 5.00, ImageURL = "http://www.clker.com/cliparts/3/9/1/d/1451508004467611065wallpaper-sliced-pizza.jpg", Active = true }
             );
        }
        ...
        private void FillDrinkSeedData(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Drink>().HasData(
                new Drink { Id = 1, Name = "Cola", Description = "Bruine frisdrank met koolzuur", MinimalPrice = 2.50, ImageURL = "https://imgs.search.brave.com/s1tlzTSdN6odOOFO1fLwEPOUyq4gnuw6DfxckSH0ylM/rs:fit:1000:1000:1/g:ce/aHR0cHM6Ly9henRl/Y21leGljYW5wcm9k/dWN0c2FuZGxpcXVv/ci5jb20uYXUvd3At/Y29udGVudC91cGxv/YWRzLzIwMjAvMDUv/UmVkLUNvbGEtY2Fu/cy1henRlYy1tZXhp/Y2FuLmpwZw", Active = true },
                new Drink { Id = 2, Name = "Spa Blauw", Description = "Water zonder koolzuur", MinimalPrice = 1.50, Active = true },
                new Drink { Id = 3, Name = "Spa Rood", Description = "Water met koolzuur", MinimalPrice = 1.50, Active = true },
                new Drink { Id = 4, Name = "Chocomel", Description = "Chocolademelk", MinimalPrice = 3.00, Active = true }
             );
        }
